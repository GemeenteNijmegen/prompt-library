...
def create_prompt(
    ...
    """Create a new prompt in draft status. Requires the `prompt:create` scope."""
    try:
...
def delete_prompt(
    ...
    """Delete a prompt. Authors and Organisation Admins may delete prompts within their organisation."""
    try:
